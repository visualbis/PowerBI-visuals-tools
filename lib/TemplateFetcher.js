...
class TemplateFetcher {
    ...
    async setApiVersion() {
        ...
        if (packageJson.devDependencies && packageJson.devDependencies["@visualbi/powerbi-visuals-api"]) {
            packageJson.devDependencies["@visualbi/powerbi-visuals-api"] = `~${this.apiVersion}`;
        }
        if (packageJson.dependencies && packageJson.dependencies["@visualbi/powerbi-visuals-api"]) {
            packageJson.dependencies["@visualbi/powerbi-visuals-api"] = `~${this.apiVersion}`;
        }
